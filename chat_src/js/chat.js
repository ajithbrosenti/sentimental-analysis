	...
	function oldmsg( receiver_id ) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				box3_html += "<div class='subelement32 round-img'><img src='img/profile_imgs/"+parse_data[0].prof_img+"' style='width:100%;height:100%;'></div><div class='subelement33'><h1>"+parse_data[0].username+"</h1>"+"<h1 id='sentiment' style='color:red'></h1>";
				$("#box3").empty();
